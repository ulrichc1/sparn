# @ulrichc1/sparn — Developer Guide
<!-- Auto-generated by Sparn v1.3.0 — 2026-02-26T22:10:54.361Z -->
...
Sparn is active in this project. Key features:
- Context optimization (60-70% token reduction)
- Use `sparn search` before reading files
- Use `sparn graph` to understand dependencies
- Use `sparn plan` for planning, `sparn exec` for execution
